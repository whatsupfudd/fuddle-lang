...
containsHelp word# ba# !offset# len# =
  isTrue# (offset# <# len#)
  &&
    (isTrue#(eqWord# word# (word8ToWord# (indexWord8Array# ba# offset#))) 
      || containsHelp word# ba# (offset# +# 1#) len#)
...
endsWithWord8 (W8# w8#) (Utf8 ba#) =
  let len# = sizeofByteArray# ba# in
  isTrue# (len# ># 0#)
  &&
  isTrue# (eqWord# (word8ToWord# w8#) (word8ToWord# (indexWord8Array# ba# (len# -# 1#))))
...
escape before@(W8# before#) after ptr name@(Utf8 ba#) offset@(I# offset#) len@(I# len#) i@(I# i#) =
  if isTrue# (i# <# len#) then
    if isTrue# (eqWord# (word8ToWord# before#) (word8ToWord# (indexWord8Array# ba# (offset# +# i#))))
    then
