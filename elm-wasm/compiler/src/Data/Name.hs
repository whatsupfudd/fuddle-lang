...
import Data.Word8 (_underscore, _M, _dollar)
      ...
      (
        ST $ \s ->
          case newByteArray# (len# +# 3#) s of
            (# s, mba# #) ->
              case writeWord8Array# mba# 0# _underscore# {- 0x5F## : _-} s of
                s ->
                  case writeWord8Array# mba# 1# _M# {- 0x4D## M-} s of
                    s ->
                      case writeWord8Array# mba# 2# _dollar# {- 0x24## : $-} s of
                        s ->
